...
BEGIN
    INSERT INTO WORK_ORDER_HIST ( ID, WORK_NO, STATUS_CODE, COMMENT, MD_CAPEX, DESCRIPTION, COMPLEXITY_CODE, COMPLEXITY, PRICE, LAST_MOD, HIST_CREATE )
    VALUES ( OLD.ID, OLD.WORK_NO, OLD.STATUS_CODE, OLD.COMMENT, OLD.MD_CAPEX, OLD.DESCRIPTION, OLD.COMPLEXITY_CODE, OLD.COMPLEXITY, OLD.PRICE, OLD.LAST_MOD, STRFTIME('%s','NOW') );
