...
CREATE TABLE CONTACT (
    ...
    FOREIGN KEY(PERSON_ID) REFERENCES WORK_ORDER(PERSON)
);
...
CREATE TABLE WORK_ORDER (
    ...
    DESCRIPTION VARCHAR(255),
    COMMENT VARCHAR(255),
    COMPLEXITY INTEGER NOT NULL, --[HOURS]
...
BEGIN
    INSERT INTO WORK_ORDER_HIST ( ID, WORK_NO, STATUS_CODE, COMMENT, COMPLEXITY, LAST_MOD, VERSION )
    VALUES ( OLD.ID, OLD.WORK_NO, OLD.STATUS_CODE, OLD.COMMENT, OLD.COMPLEXITY, OLD.LAST_MOD, OLD.VERSION );
