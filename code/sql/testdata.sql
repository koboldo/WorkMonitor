...
-- TEST ORDERS
INSERT INTO WORK_ORDER(WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY, COMPLEXITY_CODE, PRICE) VALUES ("WAW1", "AS", "AU", 8, "HRD", 1000);
INSERT INTO WORK_ORDER(WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY, COMPLEXITY_CODE, PRICE, MD_CAPEX, PROTOCOL_NO, DESCRIPTION, COMMENT) VALUES ("WAW2", "AS", "OT", 8, "HRD", 1000, "CAPEX1", "PRO332211", "Stacja na szybko", "To jest to dziwne zamownienie");
...
INSERT INTO WORK_ORDER(WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY, COMPLEXITY_CODE, PRICE, MD_CAPEX) VALUES ("KRK2", "AS", "PA", 8, "STD", 1000, "CAPEX123");
...
-- TEST RELATED ITEMS
INSERT INTO RELATED_ITEM(ITEM_NO, DESCRIPTION, ADDRESS, MD_BUILDING_TYPE, MD_CONSTRUCTION_CATEGORY) VALUES ("CAPEX1", "WIEŻA DLA ORGRIMA DOOMHAMMERA", "ul. Hordy 3", "WIEŻA ORKÓW 1", "WIEŻA STRAŻNICZA");
INSERT INTO RELATED_ITEM(ITEM_NO, DESCRIPTION, ADDRESS, MD_BUILDING_TYPE, MD_CONSTRUCTION_CATEGORY) VALUES ("CAPEX2", "ZAMEK DLA UTHERA", "pl. Sojuszu 1", "ZAMEK WAROWNY 1", "ZAMEK WAROWNY 1");
