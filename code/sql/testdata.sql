...
-- TEST PERSONS
INSERT INTO PERSON (FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, IS_ACTIVE, OFFICE_CODE, ROLE_CODE) VALUES ("Johnny","Depp", "jdepp", "e35bece6c5e6e0e86ca51d0440e92282a9d6ac8a", "Y", "WAW","EN");
INSERT INTO PERSON (FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, IS_ACTIVE, OFFICE_CODE, ROLE_CODE) VALUES ("Leonardo","DiCaprio", "ldicaprio", "e35bece6c5e6e0e86ca51d0440e92282a9d6ac8a", "Y", "POZ","EN");
INSERT INTO PERSON (FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, IS_ACTIVE, OFFICE_CODE, ROLE_CODE) VALUES ("Tom","Hanks", "thanks", "e35bece6c5e6e0e86ca51d0440e92282a9d6ac8a", "Y", "GDA","MG");
INSERT INTO PERSON (FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, IS_ACTIVE, OFFICE_CODE, ROLE_CODE) VALUES ("Brad","Pitt", "bpitt", "e35bece6c5e6e0e86ca51d0440e92282a9d6ac8a", "Y", "KRK","EN");
INSERT INTO PERSON (FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, IS_ACTIVE, OFFICE_CODE, ROLE_CODE) VALUES ("Ania","Oblatana", "oblec", "e35bece6c5e6e0e86ca51d0440e92282a9d6ac8a", "Y", "GDA","OP");
INSERT INTO PERSON (FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, IS_ACTIVE, OFFICE_CODE, ROLE_CODE) VALUES ("Bozena","Wolska", "bwolska", "e35bece6c5e6e0e86ca51d0440e92282a9d6ac8a", "Y", "GDA","PR");

-- TEST ORDERS
INSERT INTO WORK_ORDER(WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY, COMPLEXITY_CODE, PRICE) VALUES ("WAW1", "AS", "AU", 8, "STD", 1000);
INSERT INTO WORK_ORDER(WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY, COMPLEXITY_CODE, PRICE, MD_CAPEX, MD_BUILDING_TYPE, MD_CONSTRUCTION_CATEGORY) VALUES ("WAW2", "AS", "OT", 8, "STD", 1000, "CAPEX1", "WIEŻA ORKÓW 1", "WIEŻA STRAŻNICZA");
INSERT INTO WORK_ORDER(WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY, COMPLEXITY_CODE, PRICE) VALUES ("POZ1", "CO", "BU", 8, "STD", 1000);
INSERT INTO WORK_ORDER(WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY, COMPLEXITY_CODE, PRICE) VALUES ("POZ2", "AS", "PA", 8, "STD", 1000);
INSERT INTO WORK_ORDER(WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY, COMPLEXITY_CODE, PRICE) VALUES ("GDA1", "AS", "AU", 8, "STD", 1000);
INSERT INTO WORK_ORDER(WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY, COMPLEXITY_CODE, PRICE) VALUES ("GDA2", "CO", "OT", 8, "STD", 1000);
INSERT INTO WORK_ORDER(WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY, COMPLEXITY_CODE, PRICE) VALUES ("KRK1", "AS", "BU", 8, "STD", 1000);
INSERT INTO WORK_ORDER(WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY, COMPLEXITY_CODE, PRICE, MD_CAPEX, MD_BUILDING_TYPE, MD_CONSTRUCTION_CATEGORY) VALUES ("KRK2", "AS", "PA", 8, "STD", 1000, "CAPEX123", "WIEŻA ORKÓW 2", "WIEŻA STRAŻNICZA");
