...
export class WoStoppedListComponent implements OnInit {
    ...
    ngOnInit() {
        this.cols = [
            ...
            { field: 'complexityCode', header: 'Zł.', hidden:true, sortable:true, filter:false,complexity:true, icon:true,class:"text-center" },
            { field: 'complexity', header: 'Wycena' , hidden:true, sortable:true, filter:false,class:"text-center-55"},                              
