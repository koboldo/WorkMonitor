...
export class WoComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.search();
        this.cols = [
            { field: 'officeCode', header: 'Biuro' , sortable: true, filter:true,class:"text-center"},
            { field: 'id', header: 'id', hidden: true, sortable: true, filter:true},
            { field: 'workNo', header: 'Zlecenie', sortable: true, filter:true},
            { field: 'status', header: 'Status' , filter:true,statusCode:true, class:"width-135"},
            { field: 'type', header: 'Typ', sortable:true, filter:true, type:true},
            ...
            { field: 'mdCapex', header: 'CAPEX', sortable:true, filter:true },
            ...
            { field: 'assignee', header: 'Wykonawca', sortable:true, filter:true },
            { field: 'isFromPool', header: 'Pula' , sortable:true, filter:true, isFromPool:true, icon:true, class:"text-center"},
            { field: 'protocolNo', header: 'Protokół', sortable:true, filter:true },
            { field: 'lastModDate', header: 'Mod.' , sortable:true, filter:true, class:"width-82"},
            { field: 'creationDate', header: 'Utw.', sortable:true , filter:true, class:"width-82"},
            { field: 'itemNo', header: 'Numer obiektu' , sortable:true, filter:true, class:"width-82"},
            ...
            { field: 'ventureCompany', header: 'Inwestor', sortable:true , filter:true},
            { field: 'ventureDisplay', header: 'Zleceniodawca', sortable:true , filter:true },
            { button: true, icone:true, class:"width-25"}
