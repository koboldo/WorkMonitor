...
var queries = {
	getOrders: 'SELECT ID, WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY_CODE, COMPLEXITY, DESCRIPTION, COMMENT, MD_CAPEX, MD_BUILDING_TYPE, MD_CONSTRUCTION_CATEGORY, PRICE, DATETIME(LAST_MOD,"unixepoch") AS LAST_MOD FROM WORK_ORDER',
	getOrder: 'SELECT ID, WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY_CODE, COMPLEXITY, DESCRIPTION, COMMENT, MD_CAPEX, MD_BUILDING_TYPE, MD_CONSTRUCTION_CATEGORY, PRICE, DATETIME(LAST_MOD,"unixepoch") AS LAST_MOD FROM WORK_ORDER WHERE ID = ?',
	getOrderByExtId: 'SELECT ID, WORK_NO, STATUS_CODE, TYPE_CODE, COMPLEXITY_CODE, COMPLEXITY, DESCRIPTION, COMMENT, MD_CAPEX, MD_BUILDING_TYPE, MD_CONSTRUCTION_CATEGORY, PRICE, DATETIME(LAST_MOD,"unixepoch") AS LAST_MOD FROM WORK_ORDER WHERE WORK_NO = ?',
