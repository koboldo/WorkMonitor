...
const queries = {
    ...
    getProtocolNOs: 'SELECT PROTOCOL_NO, MAX(LAST_MOD) ORDERING_DATE FROM WORK_ORDER WHERE PROTOCOL_NO IS NOT NULL AND PROTOCOL_NO <> "" GROUP BY PROTOCOL_NO ORDER BY 2 DESC',
