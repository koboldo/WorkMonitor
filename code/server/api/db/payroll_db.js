...
const queries = {
    ...
    , PERIOD_WO AS (
        SELECT Q.ID, Q.WORK_NO, Q.TYPE_CODE, CAST(Q.PRICE AS DOUBLE) *  G.POOL_INCLUSION_FACTOR PRICE, Q.COMPLEXITY, Q.IS_FROM_POOL, G.POOL_INCLUSION_FACTOR
    ...
    , PERIOD_STATS AS (
       SELECT CAST(COALESCE(
            (SELECT SUM(PRICE) FROM PERIOD_WO WHERE IS_FROM_POOL = 'Y')
