...
const queries = {
	getWorkTypes: 'SELECT ID, TYPE_CODE, OFFICE_CODE, COMPLEXITY_CODE, COMPLEXITY, COMPLEXITY, DESCRIPTION, PRICE, IS_FROM_POOL, COLOR FROM WORK_TYPE',
	getWorkType: 'SELECT ID, TYPE_CODE, OFFICE_CODE, COMPLEXITY_CODE, COMPLEXITY, COMPLEXITY, DESCRIPTION, PRICE, IS_FROM_POOL, COLOR FROM WORK_TYPE WHERE ID = ?',
};
