...
var queries = {
	getPersons: 'SELECT ID, EMAIL, LAST_NAME, FIRST_NAME, OFFICE_CODE, ROLE_CODE, COMPANY, IS_ACTIVE FROM PERSON ORDER BY LAST_NAME, FIRST_NAME ASC',
	getPerson: 'SELECT ID, EMAIL, LAST_NAME, FIRST_NAME, OFFICE_CODE, ROLE_CODE, COMPANY, IS_ACTIVE FROM PERSON WHERE ID = ?',
